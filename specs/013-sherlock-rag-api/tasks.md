...
- [x] **[TASK-054]** [P] [REASONER] [P1] Wire tiktoken token counts + file_search tool detection in `openai_router.py` (FR-9, FR-14, US-13)
...
- [x] **[TASK-062]** [P] [REASONER] [P1] Bump `service.yaml` to v0.3.0, add `storage` depends_on
  - Dependencies: TASK-001
