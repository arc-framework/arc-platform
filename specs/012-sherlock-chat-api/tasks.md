...
- [x] [TASK-020] [P] [services/reasoner] [P1] Create providers/base.py + providers/__init__.py
...
- [x] [TASK-021] [P] [services/reasoner] [P1] Create providers/compatible_provider.py — default OpenAI-compatible
...
- [x] [TASK-022] [P] [services/reasoner] [P1] Create providers/openai_provider.py — OpenAI / Azure
  - Dependencies: TASK-020
...
- [x] [TASK-023] [P] [services/reasoner] [P1] Create providers/anthropic_provider.py — Claude
  - Dependencies: TASK-020
...
- [x] [TASK-024] [P] [services/reasoner] [P1] Create providers/google_provider.py — Gemini
  - Dependencies: TASK-020
...
- [x] [TASK-025] [P] [services/reasoner] [P1] Create providers/factory.py — create_provider()
...
- [x] [TASK-030] [P] [services/reasoner] [P1] Refactor llm_factory.py as backward-compat shim
...
- [x] [TASK-032] [P] [services/reasoner] [P2] Create models_router.py — GET /v1/models
...
- [x] [TASK-040] [P] [services/reasoner] [P1] Create openai_router.py — /v1/chat/completions + /v1/responses
...
- [x] [TASK-041] [P] [services/reasoner] [P1] Create openai_nats_handler.py — OpenAINATSHandler
...
- [x] [TASK-060] [P] [services/reasoner] [P1] test_providers.py — provider factory + all 4 impls
  - Dependencies: TASK-025
...
- [x] [TASK-061] [P] [services/reasoner] [P1] test_openai_router.py — /v1/chat/completions + /v1/responses
...
- [x] [TASK-062] [P] [services/reasoner] [P1] test_streaming.py — stream_graph + GraphStreamingAdapter
...
- [x] [TASK-063] [P] [services/reasoner] [P1] test_openai_nats_handler.py — OpenAINATSHandler
