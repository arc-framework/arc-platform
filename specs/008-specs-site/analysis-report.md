...
| FR-8: Configure edit_uri | Technical Context | TASK-010 | Covered |
| FR-9: Create CI workflow | Technical Context + Architecture | TASK-021 | Covered |
| FR-10: Set site_url and repo_url | Technical Context | TASK-010 | Covered |
...
- site_build/ is gitignored (FR-11)
...
- CI configuration uses standard GitHub Actions environment variables (GITHUB_TOKEN)
