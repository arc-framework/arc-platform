...
_VS_INSERT = """
INSERT INTO sherlock.vector_stores (id, name)
VALUES (:id, :name)
"""

_VS_SELECT = "SELECT id, name, created_at FROM sherlock.vector_stores WHERE id = :id"

_VS_DELETE = "DELETE FROM sherlock.vector_stores WHERE id = :id RETURNING id"

_VSF_INSERT = """
INSERT INTO sherlock.vector_store_files (vector_store_id, file_id, status)
...
FROM sherlock.vector_store_files
WHERE vector_store_id = :vs_id AND file_id = :fid
"""

_VSF_DELETE = """
DELETE FROM sherlock.vector_store_files
WHERE vector_store_id = :vs_id AND file_id = :fid
RETURNING file_id
"""
