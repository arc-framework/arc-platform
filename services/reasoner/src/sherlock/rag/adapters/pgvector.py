...
Schema DDL lives in services/persistence/initdb/004_sherlock_rag_schema.sql and
...
_INSERT_CHUNK_SQL = """\
INSERT INTO sherlock.knowledge_chunks
...
_DELETE_BY_FILE_SQL = "DELETE FROM sherlock.knowledge_chunks WHERE file_id = :file_id"

_DELETE_BY_VS_SQL = (
    "DELETE FROM sherlock.knowledge_chunks WHERE vector_store_id = :vector_store_id"
)

_CHECK_SCHEMA_SQL = "SELECT 1 FROM sherlock.knowledge_chunks LIMIT 0"
...
class PgVectorStore:
    ...
    async def init_schema(self) -> None:
        ...
        The DDL is applied by services/persistence/initdb/004_sherlock_rag_schema.sql
