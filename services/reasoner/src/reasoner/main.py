...
from reasoner.fake_router import dev_router
from reasoner.files_router import build_files_router
from reasoner.graph import GraphErrorResponse, build_graph, invoke_graph
from reasoner.llm_factory import create_llm
from reasoner.memory import SherlockMemory
from reasoner.models_router import StaticModelRegistry, build_models_router
from reasoner.nats_handler import NATSHandler
from reasoner.observability import (
    SherlockMetrics,
    configure_logging,
    init_telemetry,
    instrument_app,
)
from reasoner.openai_nats_handler import OpenAINATSHandler
from reasoner.openai_router import build_openai_router
from reasoner.pulsar_handler import PulsarHandler
from reasoner.rag.nats_handler import RAGNATSHandler
from reasoner.rag.store import RAGInfra, build_rag_infra
from reasoner.streaming import GraphStreamingAdapter
...
async def _health_probe_loop(
    ...
    """
    _probe_log = structlog.get_logger("reasoner.health_probe")
    while True:
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None]:
    ...
    log = structlog.get_logger("reasoner.startup")
...
_request_log = structlog.get_logger("reasoner.http")
