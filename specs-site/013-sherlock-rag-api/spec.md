---
url: /arc-platform/specs-site/013-sherlock-rag-api/spec.md
---
...
**US-4**: As an API client, I want to send a chat request with file\_search so that the LLM answers using my documents.
...
* \[ ] Bump `services/reasoner/service.yaml` version to `0.3.0`, add `storage` depends\_on
