---
url: /arc-platform/specs-site/012-sherlock-chat-api/tasks.md
---
...
* \[x] \[TASK-010] \[P] \[services/reasoner] \[P1] Create models\_v1.py — all OpenAI-compatible Pydantic models
  * Dependencies: none
...
* \[x] \[TASK-011] \[services/reasoner] \[P1] Create interfaces.py — 7 Protocol definitions
...
* \[x] \[TASK-020] \[P] \[services/reasoner] \[P1] Create providers/base.py + providers/**init**.py
...
* \[x] \[TASK-021] \[P] \[services/reasoner] \[P1] Create providers/compatible\_provider.py — default OpenAI-compatible
...
* \[x] \[TASK-022] \[P] \[services/reasoner] \[P1] Create providers/openai\_provider.py — OpenAI / Azure
  * Dependencies: TASK-020
...
* \[x] \[TASK-023] \[P] \[services/reasoner] \[P1] Create providers/anthropic\_provider.py — Claude
  * Dependencies: TASK-020
...
* \[x] \[TASK-024] \[P] \[services/reasoner] \[P1] Create providers/google\_provider.py — Gemini
  * Dependencies: TASK-020
...
* \[x] \[TASK-025] \[P] \[services/reasoner] \[P1] Create providers/factory.py — create\_provider()
...
* \[x] \[TASK-026] \[P] \[services/reasoner] \[P1] Add stream\_graph() to graph.py
  * Dependencies: none
...
* \[x] \[TASK-030] \[P] \[services/reasoner] \[P1] Refactor llm\_factory.py as backward-compat shim
...
* \[x] \[TASK-031] \[P] \[services/reasoner] \[P1] Create streaming.py — GraphStreamingAdapter
...
* \[x] \[TASK-032] \[P] \[services/reasoner] \[P2] Create models\_router.py — GET /v1/models
...
* \[x] \[TASK-033] \[P] \[services/reasoner] \[P1] Extend observability.py — 4 new v1 OTEL metrics
...
* \[x] \[TASK-040] \[P] \[services/reasoner] \[P1] Create openai\_router.py — /v1/chat/completions + /v1/responses
...
* \[x] \[TASK-041] \[P] \[services/reasoner] \[P1] Create openai\_nats\_handler.py — OpenAINATSHandler
...
* \[x] \[TASK-050] \[services/reasoner] \[P1] Wire everything in main.py
...
* \[x] \[TASK-051] \[P] \[services/reasoner] \[P2] Update contracts/openapi.yaml — add /v1/\* paths
...
* \[x] \[TASK-052] \[P] \[services/reasoner] \[P2] Update contracts/asyncapi.yaml + bump service.yaml
  * Dependencies: TASK-050
...
* \[x] \[TASK-053] \[services/reasoner] \[P2] Add AsyncAPI HTML generation to Dockerfile
  * Dependencies: TASK-050
...
* \[x] \[TASK-060] \[P] \[services/reasoner] \[P1] test\_providers.py — provider factory + all 4 impls
  * Dependencies: TASK-025
...
* \[x] \[TASK-061] \[P] \[services/reasoner] \[P1] test\_openai\_router.py — /v1/chat/completions + /v1/responses
...
* \[x] \[TASK-062] \[P] \[services/reasoner] \[P1] test\_streaming.py — stream\_graph + GraphStreamingAdapter
...
* \[x] \[TASK-063] \[P] \[services/reasoner] \[P1] test\_openai\_nats\_handler.py — OpenAINATSHandler
...
* \[x] \[TASK-900] \[P] \[services/reasoner] \[P2] Docs & Links Update
...
| Setup | 2 | 2 | 1 |
| Foundational | 2 | 2 | 1 |
| Implementation (Batch A) | 7 | 7 | 7 |
| Implementation (Batch B) | 4 | 4 | 4 |
| Implementation (Batch C) | 2 | 2 | 2 |
| Integration | 4 | 4 | 2 |
| Tests | 4 | 4 | 4 |
| Polish | 2 | 2 | 1 |
| **Total** | **27** | **27** | **22** |
