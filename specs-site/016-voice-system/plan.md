---
url: /arc-platform/specs-site/016-voice-system/plan.md
---
...
| VII | Observability | PASS | OTEL histograms (stt\_latency, bridge\_latency, tts\_latency, turn\_latency); `/health` + `/health/deep` |
